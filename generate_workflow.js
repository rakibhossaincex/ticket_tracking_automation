...
const js_code_main = `// ALL TEAM TICKET LOG - Enhanced with Product Type, Category-based SLA, Working Hours
...
fs.writeFileSync("Bulk Fetch - Jan 15 to Now.json", JSON.stringify(workflow, null, 2));
console.log("JSON is VALID and generated via Node.js.");
